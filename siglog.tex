...
\todo[inline]{SA: revised the following -- see comments in the source file}
%%%%%%%%%%%%
% the following expands on and applies some of the material in 107-129, but also conflicts with it in some respects.
% I have tried below to revise to avoid the repitition and make it more consistent, but this is just a suggestion.
...
program %(indeed, according to that program propositions are not just $-1$-types, but can be any $n$-type), 
% SA: omitting this remark as tangential and potnetially confusing  
...
%%%%%%%%%%%
\todo[inline]{SA: end of revision -- see comments in the source file}
