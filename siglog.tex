...
homotopical perspectives be called the \emph{Univalent Unification}\todo[author=RH]{citation required, maybe ias article?} of two major lines of development in mathematics.  A
...
the spheres.\todo[author=RH]{citations?}  In this way it is possible to unify standard, classical logic and set theory with constructive logic and
...
\newblock {\em Intuitionistic type theory}, volume~17.
